            ...
            <v-card-text class="mt-5">
              <v-form v-model="valid">
                ...
                <template>
                  ...
                  <v-img :src="url"></v-img>
                  <v-img v-if="!url" :src="potoComputed"></v-img>
                </template>
              </v-form>
            </v-card-text>
...
export default {
  ...
  methods: {
    editTipeKelas() {
      ...
      this.$store.dispatch("editTipeKelas", this.message);
    },
    Preview_image() {
  ...
  computed: {
    ...
    namaKelasComputed(){
      return this.tipekelasFromStore[this.indexyangDipilih].name;
    },
    DeskripsiComputed(){
      return this.tipekelasFromStore[this.indexyangDipilih].deskripsi;
    },
    potoComputed(){
      return this.tipekelasFromStore[this.indexyangDipilih].foto;
    },
  },
};
</script>
